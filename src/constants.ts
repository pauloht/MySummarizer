export const PROMPTS_PATH = "/scripts/extensions/third-party/MySummarizer/prompts/";

// Debug subsection
export const SUBSECTION_DEBUG = "debug";
export const KEY_DEBUG_CHAT_CONTENT = "my_debug";
